...
const AboutPage = () => {
  return (
    <>
      <Head>
        <title>About GUMUH</title>
        <meta
          name="description"
          content="Learn more about GUMUH, a pioneering Cameroonian software startup founded in 2020."
        />
        <meta property="og:title" content="About GUMUH" />
        <meta
        ...
        <meta
          property="og:image"
          content="https://gumuh.com/images/team.jpeg"
        />
        <meta property="og:url" content="https://gumuh.com/about" />
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p>
                  We strive to create innovative solutions that address the
                  unique needs of African businesses and consumers, pushing the
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p>
                  Our goal is to empower individuals and businesses across
                  Africa with tools and technologies that enhance productivity,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="mb-4">
                  ...
                  resulting in an average 30% increase in operational
                  efficiency.
                </p>
              </div>
              <div>
                ...
                <p className="mb-4">
                  ...
                  more than 100 young Cameroonian developers, contributing to
              ...
              <div>
                ...
                <p className="mb-4">
                  Our AI-powered crop disease detection app has helped over
                  1,000 small-scale farmers improve their yield and reduce crop
                  losses.
                </p>
              </div>
              <div>
                ...
                <p className="mb-4">
                  Our blockchain-based microfinance platform has facilitated
                  over 10,000 micro-loans to unbanked individuals, fostering
